...
async def query_gpt4(prompt: str, available_files: List[str]) -> Dict[str, Any]:
    ...
    folder_list_placeholder = ["Aglaophamus_dibranchis.geojson","Aidanosagitta_regularis.geojson","Charybdis__Archias__smithii.geojson","Conchoecetta_giesbrechti.geojson","Cossura_coasta.geojson","Cypridina_dentata.geojson","Euconchoecia_aculeata.geojson","Flaccisagitta_enflata.geojson","Hypnea_musciformis.geojson","Lumbrineris_latreilli.geojson","Magelona_cincta.geojson","Metaconchoecia_rotundata.geojson","Noctiluca_scintillans.geojson","Orthoconchoecia_atlantica.geojson","Paraprionospio_pinnata.geojson","Proboscia_alata.geojson","Proceroecia_procera.geojson","Pseudanchialina_pusilla.geojson","Pterosagitta_draco.geojson","Rhizosolenia_hebetata.geojson","Serratosagitta_pacifica.geojson","Sigambra_parva.geojson","Siriella_gracilis.geojson","Thalassionema_nitzschioides.geojson","Tripos_furca.geojson","Ulva_lactuca.geojson"]
